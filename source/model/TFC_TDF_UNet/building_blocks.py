...
class TFC_TDF_v1_DownSample(UNetDownSampleBlock):
    r"""
    TFC-TDF intermediate block as described in:
    `Investigating U-Nets with various Intermediate Blocks for Spectrogram-based Singing Voice Separation`,
    arxiv: https://arxiv.org/abs/1912.02591
    ...
    def __init__(self,
        ...
        super(TFC_TDF_v1_DownSample, self).__init__(unet_block=unet_block, down_block=down_block)



class TFC_TDF_v1_UpSample(UNetUpSampleBlock):
    r"""
    TFC-TDF intermediate block as described in:
    `Investigating U-Nets with various Intermediate Blocks for Spectrogram-based Singing Voice Separation`,
    arxiv: https://arxiv.org/abs/1912.02591
    ...
    def __init__(self,
        ...
        super(TFC_TDF_v1_UpSample, self).__init__(unet_block=unet_block, up_block=up_block)