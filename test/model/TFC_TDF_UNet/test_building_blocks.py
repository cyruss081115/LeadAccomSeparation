...
class TestTFC_TDF_v1_Downsample(unittest.TestCase):
    def test_init_architecture(self):
        ...
        expected_unet_block = TFC_TDF_v1(
            in_channels=in_channels,
            num_layers=num_layers,
            growth_rate=growth_rate,
            kernel_size=kernel_size,
        ...
        expected_down_block = DownSample2DBlock(
        ...
        self.assertEqual(tfc_tdf_downsample_block.unet_block.__str__(), 
                         expected_unet_block.__str__())
        self.assertEqual(tfc_tdf_downsample_block.down_block.__str__(), 
                         expected_down_block.__str__())
...
class TestTFC_TDF_v1_UpSample(unittest.TestCase):
    def test_init_architecture(self):
        ...
        tfc_tdf_up_block = TFC_TDF_v1_UpSample(
            in_channels=in_channels,
            num_layers=num_layers,
            growth_rate=growth_rate,
            kernel_size=kernel_size,
        ...
        expected_up_block = UpSample2DBlock(
            in_channels=growth_rate,
            out_channels=growth_rate,
            activation=activation,
            bias=bias
        ...
        self.assertEqual(tfc_tdf_up_block.unet_block.__str__(), 
                         expected_tfc_tdf_block.__str__())
        self.assertEqual(tfc_tdf_up_block.up_block.__str__(), 
                         expected_up_block.__str__())
